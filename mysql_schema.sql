...
-- Membuang struktur basisdata untuk information_schema
CREATE DATABASE IF NOT EXISTS `information_schema` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `information_schema`;

-- membuang struktur untuk table information_schema.ADMINISTRABLE_ROLE_AUTHORIZATIONS
...
-- membuang struktur untuk table information_schema.APPLICABLE_ROLES
...
-- membuang struktur untuk table information_schema.CHARACTER_SETS
...
-- membuang struktur untuk table information_schema.CHECK_CONSTRAINTS
...
-- membuang struktur untuk table information_schema.COLLATIONS
...
-- membuang struktur untuk table information_schema.COLLATION_CHARACTER_SET_APPLICABILITY
...
-- membuang struktur untuk table information_schema.COLUMNS
...
-- membuang struktur untuk table information_schema.COLUMNS_EXTENSIONS
...
-- membuang struktur untuk table information_schema.COLUMN_PRIVILEGES
...
-- membuang struktur untuk table information_schema.COLUMN_STATISTICS
...
-- membuang struktur untuk table information_schema.ENABLED_ROLES
...
-- membuang struktur untuk table information_schema.ENGINES
...
-- membuang struktur untuk table information_schema.EVENTS
...
-- membuang struktur untuk table information_schema.FILES
...
-- membuang struktur untuk table information_schema.INNODB_BUFFER_PAGE
...
-- membuang struktur untuk table information_schema.INNODB_BUFFER_PAGE_LRU
...
-- membuang struktur untuk table information_schema.INNODB_BUFFER_POOL_STATS
...
-- membuang struktur untuk table information_schema.INNODB_CACHED_INDEXES
...
-- membuang struktur untuk table information_schema.INNODB_CMP
...
-- membuang struktur untuk table information_schema.INNODB_CMPMEM
...
-- membuang struktur untuk table information_schema.INNODB_CMPMEM_RESET
...
-- membuang struktur untuk table information_schema.INNODB_CMP_PER_INDEX
...
-- membuang struktur untuk table information_schema.INNODB_CMP_PER_INDEX_RESET
...
-- membuang struktur untuk table information_schema.INNODB_CMP_RESET
...
-- membuang struktur untuk table information_schema.INNODB_COLUMNS
CREATE TEMPORARY TABLE IF NOT EXISTS `INNODB_COLUMNS` (
  ...
  `DEFAULT_VALUE` longblob
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Pengeluaran data tidak dipilih.

-- membuang struktur untuk table information_schema.INNODB_DATAFILES
...
-- membuang struktur untuk table information_schema.INNODB_FIELDS
...
-- membuang struktur untuk table information_schema.INNODB_FOREIGN
...
-- membuang struktur untuk table information_schema.INNODB_FOREIGN_COLS
...
-- membuang struktur untuk table information_schema.INNODB_FT_BEING_DELETED
...
-- membuang struktur untuk table information_schema.INNODB_FT_CONFIG
...
-- membuang struktur untuk table information_schema.INNODB_FT_DEFAULT_STOPWORD
...
-- membuang struktur untuk table information_schema.INNODB_FT_DELETED
...
-- membuang struktur untuk table information_schema.INNODB_FT_INDEX_CACHE
...
-- membuang struktur untuk table information_schema.INNODB_FT_INDEX_TABLE
...
-- membuang struktur untuk table information_schema.INNODB_INDEXES
...
-- membuang struktur untuk table information_schema.INNODB_METRICS
...
-- membuang struktur untuk table information_schema.INNODB_SESSION_TEMP_TABLESPACES
...
-- membuang struktur untuk table information_schema.INNODB_TABLES
...
-- membuang struktur untuk table information_schema.INNODB_TABLESPACES
...
-- membuang struktur untuk table information_schema.INNODB_TABLESPACES_BRIEF
...
-- membuang struktur untuk table information_schema.INNODB_TABLESTATS
...
-- membuang struktur untuk table information_schema.INNODB_TEMP_TABLE_INFO
...
-- membuang struktur untuk table information_schema.INNODB_TRX
...
-- membuang struktur untuk table information_schema.INNODB_VIRTUAL
...
-- membuang struktur untuk table information_schema.OPTIMIZER_TRACE
...
-- membuang struktur untuk table information_schema.PARAMETERS
...
-- membuang struktur untuk table information_schema.PARTITIONS
...
-- membuang struktur untuk table information_schema.PLUGINS
...
-- membuang struktur untuk table information_schema.PROCESSLIST
...
-- membuang struktur untuk table information_schema.PROFILING
...
-- membuang struktur untuk table information_schema.REFERENTIAL_CONSTRAINTS
...
-- membuang struktur untuk table information_schema.RESOURCE_GROUPS
...
-- membuang struktur untuk table information_schema.ROLE_COLUMN_GRANTS
...
-- membuang struktur untuk table information_schema.ROLE_ROUTINE_GRANTS
...
-- membuang struktur untuk table information_schema.ROLE_TABLE_GRANTS
...
-- membuang struktur untuk table information_schema.ROUTINES
...
-- membuang struktur untuk table information_schema.SCHEMATA
...
-- membuang struktur untuk table information_schema.SCHEMATA_EXTENSIONS
...
-- membuang struktur untuk table information_schema.SCHEMA_PRIVILEGES
...
-- membuang struktur untuk table information_schema.STATISTICS
...
-- membuang struktur untuk table information_schema.ST_GEOMETRY_COLUMNS
...
-- membuang struktur untuk table information_schema.ST_SPATIAL_REFERENCE_SYSTEMS
...
-- membuang struktur untuk table information_schema.ST_UNITS_OF_MEASURE
...
-- membuang struktur untuk table information_schema.TABLES
...
-- membuang struktur untuk table information_schema.TABLESPACES_EXTENSIONS
...
-- membuang struktur untuk table information_schema.TABLES_EXTENSIONS
...
-- membuang struktur untuk table information_schema.TABLE_CONSTRAINTS
...
-- membuang struktur untuk table information_schema.TABLE_CONSTRAINTS_EXTENSIONS
...
-- membuang struktur untuk table information_schema.TABLE_PRIVILEGES
...
-- membuang struktur untuk table information_schema.TRIGGERS
...
-- membuang struktur untuk table information_schema.USER_ATTRIBUTES
...
-- membuang struktur untuk table information_schema.USER_PRIVILEGES
...
-- membuang struktur untuk table information_schema.VIEWS
...
-- membuang struktur untuk table information_schema.VIEW_ROUTINE_USAGE
...
-- membuang struktur untuk table information_schema.VIEW_TABLE_USAGE
...
-- Membuang struktur basisdata untuk mysql
...
-- membuang struktur untuk table mysql.columns_priv
...
-- membuang struktur untuk table mysql.component
...
-- membuang struktur untuk table mysql.db
...
-- membuang struktur untuk table mysql.default_roles
...
-- membuang struktur untuk table mysql.engine_cost
...
-- membuang struktur untuk table mysql.func
...
-- membuang struktur untuk table mysql.general_log
...
-- membuang struktur untuk table mysql.global_grants
...
-- membuang struktur untuk table mysql.gtid_executed
...
-- membuang struktur untuk table mysql.help_category
...
-- membuang struktur untuk table mysql.help_keyword
...
-- membuang struktur untuk table mysql.help_relation
...
-- membuang struktur untuk table mysql.help_topic
...
-- membuang struktur untuk table mysql.innodb_index_stats
...
-- membuang struktur untuk table mysql.innodb_table_stats
...
-- membuang struktur untuk table mysql.ndb_binlog_index
...
-- membuang struktur untuk table mysql.password_history
...
-- membuang struktur untuk table mysql.plugin
...
-- membuang struktur untuk table mysql.procs_priv
...
-- membuang struktur untuk table mysql.proxies_priv
...
-- membuang struktur untuk table mysql.replication_asynchronous_connection_failover
...
-- membuang struktur untuk table mysql.replication_asynchronous_connection_failover_managed
...
-- membuang struktur untuk table mysql.replication_group_configuration_version
...
-- membuang struktur untuk table mysql.replication_group_member_actions
...
-- membuang struktur untuk table mysql.role_edges
...
-- membuang struktur untuk table mysql.servers
...
-- membuang struktur untuk table mysql.server_cost
...
-- membuang struktur untuk table mysql.slave_master_info
...
-- membuang struktur untuk table mysql.slave_relay_log_info
...
-- membuang struktur untuk table mysql.slave_worker_info
...
-- membuang struktur untuk table mysql.slow_log
...
-- membuang struktur untuk table mysql.tables_priv
...
-- membuang struktur untuk table mysql.time_zone
...
-- membuang struktur untuk table mysql.time_zone_leap_second
...
-- membuang struktur untuk table mysql.time_zone_name
...
-- membuang struktur untuk table mysql.time_zone_transition
...
-- membuang struktur untuk table mysql.time_zone_transition_type
...
-- membuang struktur untuk table mysql.user
...
-- Membuang struktur basisdata untuk performance_schema
...
-- membuang struktur untuk table performance_schema.accounts
...
-- membuang struktur untuk table performance_schema.binary_log_transaction_compression_stats
...
-- membuang struktur untuk table performance_schema.cond_instances
...
-- membuang struktur untuk table performance_schema.data_locks
...
-- membuang struktur untuk table performance_schema.data_lock_waits
...
-- membuang struktur untuk table performance_schema.error_log
...
-- membuang struktur untuk table performance_schema.events_errors_summary_by_account_by_error
...
-- membuang struktur untuk table performance_schema.events_errors_summary_by_host_by_error
...
-- membuang struktur untuk table performance_schema.events_errors_summary_by_thread_by_error
...
-- membuang struktur untuk table performance_schema.events_errors_summary_by_user_by_error
...
-- membuang struktur untuk table performance_schema.events_errors_summary_global_by_error
...
-- membuang struktur untuk table performance_schema.events_stages_current
...
-- membuang struktur untuk table performance_schema.events_stages_history
...
-- membuang struktur untuk table performance_schema.events_stages_history_long
...
-- membuang struktur untuk table performance_schema.events_stages_summary_by_account_by_event_name
...
-- membuang struktur untuk table performance_schema.events_stages_summary_by_host_by_event_name
...
-- membuang struktur untuk table performance_schema.events_stages_summary_by_thread_by_event_name
...
-- membuang struktur untuk table performance_schema.events_stages_summary_by_user_by_event_name
...
-- membuang struktur untuk table performance_schema.events_stages_summary_global_by_event_name
...
-- membuang struktur untuk table performance_schema.events_statements_current
...
-- membuang struktur untuk table performance_schema.events_statements_histogram_by_digest
...
-- membuang struktur untuk table performance_schema.events_statements_histogram_global
...
-- membuang struktur untuk table performance_schema.events_statements_history
...
-- membuang struktur untuk table performance_schema.events_statements_history_long
...
-- membuang struktur untuk table performance_schema.events_statements_summary_by_account_by_event_name
...
-- membuang struktur untuk table performance_schema.events_statements_summary_by_digest
...
-- membuang struktur untuk table performance_schema.events_statements_summary_by_host_by_event_name
...
-- membuang struktur untuk table performance_schema.events_statements_summary_by_program
...
-- membuang struktur untuk table performance_schema.events_statements_summary_by_thread_by_event_name
...
-- membuang struktur untuk table performance_schema.events_statements_summary_by_user_by_event_name
...
-- membuang struktur untuk table performance_schema.events_statements_summary_global_by_event_name
...
-- membuang struktur untuk table performance_schema.events_transactions_current
...
-- membuang struktur untuk table performance_schema.events_transactions_history
...
-- membuang struktur untuk table performance_schema.events_transactions_history_long
...
-- membuang struktur untuk table performance_schema.events_transactions_summary_by_account_by_event_name
...
-- membuang struktur untuk table performance_schema.events_transactions_summary_by_host_by_event_name
...
-- membuang struktur untuk table performance_schema.events_transactions_summary_by_thread_by_event_name
...
-- membuang struktur untuk table performance_schema.events_transactions_summary_by_user_by_event_name
...
-- membuang struktur untuk table performance_schema.events_transactions_summary_global_by_event_name
...
-- membuang struktur untuk table performance_schema.events_waits_current
...
-- membuang struktur untuk table performance_schema.events_waits_history
...
-- membuang struktur untuk table performance_schema.events_waits_history_long
...
-- membuang struktur untuk table performance_schema.events_waits_summary_by_account_by_event_name
...
-- membuang struktur untuk table performance_schema.events_waits_summary_by_host_by_event_name
...
-- membuang struktur untuk table performance_schema.events_waits_summary_by_instance
...
-- membuang struktur untuk table performance_schema.events_waits_summary_by_thread_by_event_name
...
-- membuang struktur untuk table performance_schema.events_waits_summary_by_user_by_event_name
...
-- membuang struktur untuk table performance_schema.events_waits_summary_global_by_event_name
...
-- membuang struktur untuk table performance_schema.file_instances
...
-- membuang struktur untuk table performance_schema.file_summary_by_event_name
...
-- membuang struktur untuk table performance_schema.file_summary_by_instance
...
-- membuang struktur untuk table performance_schema.global_status
...
-- membuang struktur untuk table performance_schema.global_variables
...
-- membuang struktur untuk table performance_schema.hosts
...
-- membuang struktur untuk table performance_schema.host_cache
...
-- membuang struktur untuk table performance_schema.innodb_redo_log_files
...
-- membuang struktur untuk table performance_schema.keyring_component_status
...
-- membuang struktur untuk table performance_schema.keyring_keys
...
-- membuang struktur untuk table performance_schema.log_status
...
-- membuang struktur untuk table performance_schema.memory_summary_by_account_by_event_name
...
-- membuang struktur untuk table performance_schema.memory_summary_by_host_by_event_name
...
-- membuang struktur untuk table performance_schema.memory_summary_by_thread_by_event_name
...
-- membuang struktur untuk table performance_schema.memory_summary_by_user_by_event_name
...
-- membuang struktur untuk table performance_schema.memory_summary_global_by_event_name
...
-- membuang struktur untuk table performance_schema.metadata_locks
...
-- membuang struktur untuk table performance_schema.mutex_instances
...
-- membuang struktur untuk table performance_schema.objects_summary_global_by_type
...
-- membuang struktur untuk table performance_schema.performance_timers
...
-- membuang struktur untuk table performance_schema.persisted_variables
...
-- membuang struktur untuk table performance_schema.prepared_statements_instances
...
-- membuang struktur untuk table performance_schema.processlist
...
-- membuang struktur untuk table performance_schema.replication_applier_configuration
...
-- membuang struktur untuk table performance_schema.replication_applier_filters
...
-- membuang struktur untuk table performance_schema.replication_applier_global_filters
...
-- membuang struktur untuk table performance_schema.replication_applier_status
...
-- membuang struktur untuk table performance_schema.replication_applier_status_by_coordinator
...
-- membuang struktur untuk table performance_schema.replication_applier_status_by_worker
...
-- membuang struktur untuk table performance_schema.replication_asynchronous_connection_failover
CREATE TABLE IF NOT EXISTS `replication_asynchronous_connection_failover` (
  `CHANNEL_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'The replication channel name that connects source and replica.',
  `HOST` char(255) CHARACTER SET ascii COLLATE ascii_general_ci NOT NULL COMMENT 'The source hostname that the replica will attempt to switch over the replication connection to in case of a failure.',
...
-- membuang struktur untuk table performance_schema.replication_asynchronous_connection_failover_managed
CREATE TABLE IF NOT EXISTS `replication_asynchronous_connection_failover_managed` (
  `CHANNEL_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'The replication channel name that connects source and replica.',
  `MANAGED_NAME` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT 'The name of the source which needs to be managed.',
  `MANAGED_TYPE` char(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT 'Determines the managed type.',
...
-- membuang struktur untuk table performance_schema.replication_connection_configuration
...
-- membuang struktur untuk table performance_schema.replication_connection_status
...
-- membuang struktur untuk table performance_schema.replication_group_members
...
-- membuang struktur untuk table performance_schema.replication_group_member_stats
...
-- membuang struktur untuk table performance_schema.rwlock_instances
...
-- membuang struktur untuk table performance_schema.session_account_connect_attrs
...
-- membuang struktur untuk table performance_schema.session_connect_attrs
...
-- membuang struktur untuk table performance_schema.session_status
...
-- membuang struktur untuk table performance_schema.session_variables
...
-- membuang struktur untuk table performance_schema.setup_actors
...
-- membuang struktur untuk table performance_schema.setup_consumers
...
-- membuang struktur untuk table performance_schema.setup_instruments
...
-- membuang struktur untuk table performance_schema.setup_meters
CREATE TABLE IF NOT EXISTS `setup_meters` (
...
-- membuang struktur untuk table performance_schema.setup_metrics
...
-- membuang struktur untuk table performance_schema.setup_objects
...
-- membuang struktur untuk table performance_schema.setup_threads
...
-- membuang struktur untuk table performance_schema.socket_instances
...
-- membuang struktur untuk table performance_schema.socket_summary_by_event_name
...
-- membuang struktur untuk table performance_schema.socket_summary_by_instance
...
-- membuang struktur untuk table performance_schema.status_by_account
...
-- membuang struktur untuk table performance_schema.status_by_host
...
-- membuang struktur untuk table performance_schema.status_by_thread
...
-- membuang struktur untuk table performance_schema.status_by_user
...
-- membuang struktur untuk table performance_schema.table_handles
...
-- membuang struktur untuk table performance_schema.table_io_waits_summary_by_index_usage
...
-- membuang struktur untuk table performance_schema.table_io_waits_summary_by_table
...
-- membuang struktur untuk table performance_schema.table_lock_waits_summary_by_table
...
-- membuang struktur untuk table performance_schema.threads
...
-- membuang struktur untuk table performance_schema.tls_channel_status
...
-- membuang struktur untuk table performance_schema.users
...
-- membuang struktur untuk table performance_schema.user_defined_functions
...
-- membuang struktur untuk table performance_schema.user_variables_by_thread
...
-- membuang struktur untuk table performance_schema.variables_by_thread
...
-- membuang struktur untuk table performance_schema.variables_info
...
-- Membuang struktur basisdata untuk sys
...
-- membuang struktur untuk procedure sys.create_synonym_db
DELIMITER //
...
-- membuang struktur untuk procedure sys.diagnostics
DELIMITER //
...
-- membuang struktur untuk procedure sys.execute_prepared_stmt
DELIMITER //
...
-- membuang struktur untuk function sys.extract_schema_from_file_name
DELIMITER //
...
-- membuang struktur untuk function sys.extract_table_from_file_name
DELIMITER //
...
-- membuang struktur untuk function sys.format_bytes
DELIMITER //
...
-- membuang struktur untuk function sys.format_path
DELIMITER //
...
-- membuang struktur untuk function sys.format_statement
DELIMITER //
...
-- membuang struktur untuk function sys.format_time
DELIMITER //
...
-- membuang struktur untuk view sys.host_summary
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `host_summary` (
	`host` VARCHAR(1) NULL COLLATE 'ascii_general_ci',
	`statements` DECIMAL(64,0) NULL,
	`statement_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`statement_avg_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`table_scans` DECIMAL(65,0) NULL,
	`file_ios` DECIMAL(64,0) NULL,
	`file_io_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`current_connections` DECIMAL(41,0) NULL,
	`total_connections` DECIMAL(41,0) NULL,
	`unique_users` BIGINT NOT NULL,
	`current_memory` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`total_memory_allocated` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.host_summary_by_file_io
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `host_summary_by_file_io` (
	`host` VARCHAR(1) NULL COLLATE 'ascii_general_ci',
	`ios` DECIMAL(42,0) NULL,
	`io_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.host_summary_by_file_io_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `host_summary_by_file_io_type` (
	`host` VARCHAR(1) NULL COLLATE 'ascii_general_ci',
	`event_name` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` BIGINT UNSIGNED NOT NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.host_summary_by_stages
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `host_summary_by_stages` (
	...
	`total` BIGINT UNSIGNED NOT NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.host_summary_by_statement_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `host_summary_by_statement_latency` (
	...
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`lock_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`cpu_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
...
-- membuang struktur untuk view sys.host_summary_by_statement_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `host_summary_by_statement_type` (
	`host` VARCHAR(1) NULL COLLATE 'ascii_general_ci',
	`statement` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` BIGINT UNSIGNED NOT NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`lock_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
...
-- membuang struktur untuk view sys.innodb_buffer_stats_by_schema
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `innodb_buffer_stats_by_schema` (
	`object_schema` TEXT NULL COLLATE 'utf8mb3_general_ci',
	`allocated` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`data` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
...
-- membuang struktur untuk view sys.innodb_buffer_stats_by_table
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.innodb_lock_waits
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `innodb_lock_waits` (
	`wait_started` DATETIME NULL,
	`wait_age` TIME NULL,
	`wait_age_secs` BIGINT NULL,
	`locked_table` MEDIUMTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`locked_table_schema` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`locked_table_name` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`locked_table_partition` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`locked_table_subpartition` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`locked_index` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`locked_type` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_trx_id` BIGINT UNSIGNED NOT NULL,
	...
	`waiting_lock_id` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_lock_mode` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`blocking_trx_id` BIGINT UNSIGNED NOT NULL,
	`blocking_pid` BIGINT UNSIGNED NOT NULL,
	`blocking_query` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`blocking_lock_id` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`blocking_lock_mode` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	...
	`sql_kill_blocking_query` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`sql_kill_blocking_connection` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.io_by_thread_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `io_by_thread_by_latency` (
	`user` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` DECIMAL(42,0) NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`min_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`thread_id` BIGINT UNSIGNED NOT NULL,
...
-- membuang struktur untuk view sys.io_global_by_file_by_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `io_global_by_file_by_bytes` (
	`file` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`count_read` BIGINT UNSIGNED NOT NULL,
	`total_read` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_read` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`count_write` BIGINT UNSIGNED NOT NULL,
	`total_written` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_write` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`total` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`write_pct` DECIMAL(26,2) NOT NULL
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.io_global_by_file_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `io_global_by_file_by_latency` (
	...
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`count_read` BIGINT UNSIGNED NOT NULL,
	`read_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`count_write` BIGINT UNSIGNED NOT NULL,
	`write_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`count_misc` BIGINT UNSIGNED NOT NULL,
	`misc_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.io_global_by_wait_by_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `io_global_by_wait_by_bytes` (
	`event_name` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` BIGINT UNSIGNED NOT NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`min_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	...
	`count_write` BIGINT UNSIGNED NOT NULL,
	`total_written` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_written` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`total_requested` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.io_global_by_wait_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.latest_file_io
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `latest_file_io` (
	`thread` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`file` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`operation` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`requested` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk function sys.list_add
DELIMITER //
...
-- membuang struktur untuk function sys.list_drop
DELIMITER //
...
-- membuang struktur untuk view sys.memory_by_host_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `memory_by_host_by_current_bytes` (
	`host` VARCHAR(1) NULL COLLATE 'ascii_general_ci',
	`current_count_used` DECIMAL(41,0) NULL,
	`current_allocated` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`current_avg_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`current_max_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`total_allocated` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.memory_by_thread_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.memory_by_user_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `memory_by_user_by_current_bytes` (
	`user` VARCHAR(1) NULL COLLATE 'utf8mb4_bin',
	`current_count_used` DECIMAL(41,0) NULL,
	`current_allocated` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`current_avg_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`current_max_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
...
-- membuang struktur untuk view sys.memory_global_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `memory_global_by_current_bytes` (
	`event_name` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`current_count` BIGINT NOT NULL,
	`current_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`current_avg_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`high_count` BIGINT NOT NULL,
	`high_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`high_avg_alloc` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.memory_global_total
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `memory_global_total` (
	`total_allocated` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.metrics
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `metrics` (
	`Variable_name` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`Variable_value` TEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`Type` VARCHAR(1) NOT NULL COLLATE 'utf8mb3_general_ci',
	`Enabled` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.processlist
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `processlist` (
	`thd_id` BIGINT UNSIGNED NOT NULL,
	`conn_id` BIGINT UNSIGNED NULL,
	`user` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`db` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`command` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`state` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`time` BIGINT NULL,
	...
	`tmp_tables` BIGINT UNSIGNED NULL,
	`tmp_disk_tables` BIGINT UNSIGNED NULL,
	`full_scan` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_statement` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_statement_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`current_memory` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`last_wait` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_wait_latency` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`source` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`trx_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	...
	`pid` VARCHAR(1) NULL COLLATE 'utf8mb4_bin',
	`program_name` VARCHAR(1) NULL COLLATE 'utf8mb4_bin'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.ps_check_lost_instrumentation
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `ps_check_lost_instrumentation` (
	`variable_name` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`variable_value` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk function sys.ps_is_account_enabled
DELIMITER //
...
-- membuang struktur untuk function sys.ps_is_consumer_enabled
DELIMITER //
...
-- membuang struktur untuk function sys.ps_is_instrument_default_enabled
DELIMITER //
...
-- membuang struktur untuk function sys.ps_is_instrument_default_timed
DELIMITER //
...
-- membuang struktur untuk function sys.ps_is_thread_instrumented
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_disable_background_threads
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_disable_consumer
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_disable_instrument
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_disable_thread
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_enable_background_threads
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_enable_consumer
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_enable_instrument
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_enable_thread
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_reload_saved
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_reset_to_default
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_save
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_show_disabled
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_show_disabled_consumers
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_show_disabled_instruments
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_show_enabled
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_show_enabled_consumers
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_setup_show_enabled_instruments
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_statement_avg_latency_histogram
DELIMITER //
...
-- membuang struktur untuk function sys.ps_thread_account
DELIMITER //
...
-- membuang struktur untuk function sys.ps_thread_id
DELIMITER //
...
-- membuang struktur untuk function sys.ps_thread_stack
DELIMITER //
...
-- membuang struktur untuk function sys.ps_thread_trx_info
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_trace_statement_digest
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_trace_thread
DELIMITER //
...
-- membuang struktur untuk procedure sys.ps_truncate_all_tables
DELIMITER //
...
-- membuang struktur untuk function sys.quote_identifier
DELIMITER //
...
-- membuang struktur untuk view sys.schema_auto_increment_columns
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_auto_increment_columns` (
	`table_schema` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`table_name` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`column_name` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	...
	`max_value` BIGINT UNSIGNED NULL,
	`auto_increment` BIGINT UNSIGNED NULL,
	`auto_increment_ratio` DECIMAL(25,4) UNSIGNED NULL
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_index_statistics
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_index_statistics` (
	`table_schema` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`table_name` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`index_name` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`rows_selected` BIGINT UNSIGNED NOT NULL,
	`select_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`rows_inserted` BIGINT UNSIGNED NOT NULL,
	`insert_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`rows_updated` BIGINT UNSIGNED NOT NULL,
	`update_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`rows_deleted` BIGINT UNSIGNED NOT NULL,
	`delete_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_object_overview
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_object_overview` (
	`db` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`object_type` VARCHAR(1) NULL COLLATE 'utf8mb3_bin',
	`count` BIGINT NOT NULL
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_redundant_indexes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_redundant_indexes` (
	`table_schema` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`table_name` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`redundant_index_name` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`redundant_index_columns` TEXT NULL COLLATE 'utf8mb3_tolower_ci',
	`redundant_index_non_unique` INT NULL,
	`dominant_index_name` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`dominant_index_columns` TEXT NULL COLLATE 'utf8mb3_tolower_ci',
	`dominant_index_non_unique` INT NULL,
	`subpart_exists` INT NOT NULL,
	`sql_drop_index` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_tables_with_full_table_scans
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_tables_with_full_table_scans` (
	`object_schema` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`object_name` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`rows_full_scanned` BIGINT UNSIGNED NOT NULL,
	`latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_table_lock_waits
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_table_lock_waits` (
	`object_schema` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`object_name` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_thread_id` BIGINT UNSIGNED NOT NULL,
	`waiting_pid` BIGINT UNSIGNED NULL,
	`waiting_account` TEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_lock_type` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_lock_duration` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_query` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`waiting_query_secs` BIGINT NULL,
	`waiting_query_rows_affected` BIGINT UNSIGNED NULL,
	`waiting_query_rows_examined` BIGINT UNSIGNED NULL,
	`blocking_thread_id` BIGINT UNSIGNED NOT NULL,
	`blocking_pid` BIGINT UNSIGNED NULL,
	`blocking_account` TEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`blocking_lock_type` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`blocking_lock_duration` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`sql_kill_blocking_query` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`sql_kill_blocking_connection` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_table_statistics
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_table_statistics` (
	...
	`fetch_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`rows_inserted` BIGINT UNSIGNED NOT NULL,
	`insert_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`rows_updated` BIGINT UNSIGNED NOT NULL,
	`update_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	...
	`io_read` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`io_read_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`io_write_requests` DECIMAL(42,0) NULL,
	`io_write` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`io_write_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_table_statistics_with_buffer
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `schema_table_statistics_with_buffer` (
	...
	`io_misc_requests` DECIMAL(42,0) NULL,
	`io_misc_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_allocated` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_data` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_free` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`innodb_buffer_pages` BIGINT NULL,
	`innodb_buffer_pages_hashed` BIGINT NULL,
	`innodb_buffer_pages_old` BIGINT NULL,
	`innodb_buffer_rows_cached` DECIMAL(45,0) NULL
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.schema_unused_indexes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.session
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.session_ssl_status
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `session_ssl_status` (
	`thread_id` BIGINT UNSIGNED NOT NULL,
	`ssl_version` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`ssl_cipher` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`ssl_sessions_reused` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.statements_with_errors_or_warnings
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `statements_with_errors_or_warnings` (
	...
	`first_seen` TIMESTAMP(6) NOT NULL,
	`last_seen` TIMESTAMP(6) NOT NULL,
	`digest` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.statements_with_full_table_scans
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.statements_with_runtimes_in_95th_percentile
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.statements_with_sorting
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.statements_with_temp_tables
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.statement_analysis
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `statement_analysis` (
	...
	`rows_sorted` BIGINT UNSIGNED NOT NULL,
	`sort_merge_passes` BIGINT UNSIGNED NOT NULL,
	`max_controlled_memory` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`max_total_memory` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`digest` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`first_seen` TIMESTAMP(6) NOT NULL,
	`last_seen` TIMESTAMP(6) NOT NULL
) ENGINE=MyISAM;

-- membuang struktur untuk procedure sys.statement_performance_analyzer
DELIMITER //
...
-- membuang struktur untuk table sys.sys_config
...
-- membuang struktur untuk function sys.sys_get_config
DELIMITER //
...
-- membuang struktur untuk procedure sys.table_exists
DELIMITER //
...
-- membuang struktur untuk view sys.user_summary
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.user_summary_by_file_io
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.user_summary_by_file_io_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.user_summary_by_stages
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.user_summary_by_statement_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.user_summary_by_statement_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.version
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `version` (
	`sys_version` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`mysql_version` VARCHAR(1) NOT NULL COLLATE 'utf8mb3_general_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk function sys.version_major
DELIMITER //
...
-- membuang struktur untuk function sys.version_minor
DELIMITER //
...
-- membuang struktur untuk function sys.version_patch
DELIMITER //
...
-- membuang struktur untuk view sys.waits_by_host_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `waits_by_host_by_latency` (
	`host` VARCHAR(1) NULL COLLATE 'ascii_general_ci',
	`event` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` BIGINT UNSIGNED NOT NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
...
-- membuang struktur untuk view sys.waits_by_user_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.waits_global_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `waits_global_by_latency` (
	`events` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` BIGINT UNSIGNED NOT NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`max_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci'
...
-- membuang struktur untuk view sys.wait_classes_global_by_avg_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `wait_classes_global_by_avg_latency` (
	`event_class` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` DECIMAL(42,0) NULL,
	`total_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`min_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
	`avg_latency` VARCHAR(1) NULL COLLATE 'utf8mb3_general_ci',
...
-- membuang struktur untuk view sys.wait_classes_global_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$host_summary
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$host_summary_by_file_io
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$host_summary_by_file_io_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$host_summary_by_stages
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$host_summary_by_statement_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$host_summary_by_statement_latency` (
	`host` VARCHAR(1) NULL COLLATE 'ascii_general_ci',
	`total` DECIMAL(42,0) NULL,
	`total_latency` DECIMAL(42,0) NULL,
	`max_latency` BIGINT UNSIGNED NULL,
...
-- membuang struktur untuk view sys.x$host_summary_by_statement_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$host_summary_by_statement_type` (
	...
	`cpu_latency` BIGINT UNSIGNED NOT NULL,
	`rows_sent` BIGINT UNSIGNED NOT NULL,
	`rows_examined` BIGINT UNSIGNED NOT NULL,
	`rows_affected` BIGINT UNSIGNED NOT NULL,
	`full_scans` BIGINT UNSIGNED NOT NULL
...
-- membuang struktur untuk view sys.x$innodb_buffer_stats_by_schema
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$innodb_buffer_stats_by_table
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$innodb_lock_waits
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$io_by_thread_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$io_by_thread_by_latency` (
	`user` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`total` DECIMAL(42,0) NULL,
	`total_latency` DECIMAL(42,0) NULL,
	`min_latency` BIGINT UNSIGNED NULL,
...
-- membuang struktur untuk view sys.x$io_global_by_file_by_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$io_global_by_file_by_bytes` (
	`file` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`count_read` BIGINT UNSIGNED NOT NULL,
...
-- membuang struktur untuk view sys.x$io_global_by_file_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$io_global_by_wait_by_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$io_global_by_wait_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$latest_file_io
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$latest_file_io` (
	`thread` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`file` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`latency` BIGINT UNSIGNED NULL,
	`operation` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`requested` BIGINT NULL
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.x$memory_by_host_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$memory_by_host_by_current_bytes` (
	...
	`current_max_alloc` BIGINT NULL,
	`total_allocated` DECIMAL(42,0) NULL
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.x$memory_by_thread_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$memory_by_user_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$memory_global_by_current_bytes
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$memory_global_total
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$memory_global_total` (
	`total_allocated` DECIMAL(41,0) NULL
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.x$processlist
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$processlist` (
	...
	`current_statement` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`execution_engine` ENUM('PRIMARY','SECONDARY') NULL COLLATE 'utf8mb4_0900_ai_ci',
	`statement_latency` BIGINT UNSIGNED NULL,
	`progress` DECIMAL(26,2) NULL,
	`lock_latency` BIGINT UNSIGNED NULL,
	`cpu_latency` BIGINT UNSIGNED NULL,
	`rows_examined` BIGINT UNSIGNED NULL,
	`rows_sent` BIGINT UNSIGNED NULL,
	`rows_affected` BIGINT UNSIGNED NULL,
	`tmp_tables` BIGINT UNSIGNED NULL,
	...
	`full_scan` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_statement` LONGTEXT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_statement_latency` BIGINT UNSIGNED NULL,
	`current_memory` DECIMAL(41,0) NULL,
	`last_wait` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`last_wait_latency` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`source` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
	`trx_latency` BIGINT UNSIGNED NULL,
	`trx_state` ENUM('ACTIVE','COMMITTED','ROLLED BACK') NULL COLLATE 'utf8mb4_0900_ai_ci',
	`trx_autocommit` ENUM('YES','NO') NULL COLLATE 'utf8mb4_0900_ai_ci',
	`pid` VARCHAR(1) NULL COLLATE 'utf8mb4_bin',
	`program_name` VARCHAR(1) NULL COLLATE 'utf8mb4_bin'
...
-- membuang struktur untuk view sys.x$ps_digest_95th_percentile_by_avg_us
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$ps_digest_avg_latency_distribution
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$ps_schema_table_statistics_io
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$schema_flattened_keys
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$schema_flattened_keys` (
	`table_schema` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`table_name` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`index_name` VARCHAR(1) NULL COLLATE 'utf8mb3_tolower_ci',
	`non_unique` INT NULL,
	`subpart_exists` BIGINT NULL,
	`index_columns` TEXT NULL COLLATE 'utf8mb3_tolower_ci'
) ENGINE=MyISAM;

-- membuang struktur untuk view sys.x$schema_index_statistics
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$schema_tables_with_full_table_scans
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$schema_table_lock_waits
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$schema_table_statistics
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$schema_table_statistics_with_buffer
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$session
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$statements_with_errors_or_warnings
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$statements_with_full_table_scans
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$statements_with_runtimes_in_95th_percentile
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$statements_with_sorting
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$statements_with_temp_tables
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$statement_analysis
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
CREATE TABLE `x$statement_analysis` (
	...
	`full_scan` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
	`exec_count` BIGINT UNSIGNED NOT NULL,
	`exec_secondary_count` BIGINT UNSIGNED NOT NULL,
	`err_count` BIGINT UNSIGNED NOT NULL,
	`warn_count` BIGINT UNSIGNED NOT NULL,
	`total_latency` BIGINT UNSIGNED NOT NULL,
	`max_latency` BIGINT UNSIGNED NOT NULL,
...
-- membuang struktur untuk view sys.x$user_summary
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$user_summary_by_file_io
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$user_summary_by_file_io_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$user_summary_by_stages
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$user_summary_by_statement_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$user_summary_by_statement_type
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$waits_by_host_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$waits_by_user_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$waits_global_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$wait_classes_global_by_avg_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk view sys.x$wait_classes_global_by_latency
-- Membuat tabel sementara untuk menangani kesalahan ketergantungan VIEW
...
-- membuang struktur untuk trigger sys.sys_config_insert_set_user
...
-- membuang struktur untuk trigger sys.sys_config_update_set_user
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `x$memory_by_thread_by_current_bytes` (`thread_id`,`user`,`current_count_used`,`current_allocated`,`current_avg_alloc`,`current_max_alloc`,`total_allocated`) AS select `t`.`THREAD_ID` AS `thread_id`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',convert(`t`.`PROCESSLIST_HOST` using utf8mb4)),replace(`t`.`NAME`,'thread/','')) AS `user`,sum(`mt`.`CURRENT_COUNT_USED`) AS `current_count_used`,sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_allocated`,ifnull((sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) / nullif(sum(`mt`.`CURRENT_COUNT_USED`),0)),0) AS `current_avg_alloc`,max(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `current_max_alloc`,sum(`mt`.`SUM_NUMBER_OF_BYTES_ALLOC`) AS `total_allocated` from (`performance_schema`.`memory_summary_by_thread_by_event_name` `mt` join `performance_schema`.`threads` `t` on((`mt`.`THREAD_ID` = `t`.`THREAD_ID`))) group by `t`.`THREAD_ID`,if((`t`.`NAME` = 'thread/sql/one_connection'),concat(`t`.`PROCESSLIST_USER`,'@',convert(`t`.`PROCESSLIST_HOST` using utf8mb4)),replace(`t`.`NAME`,'thread/','')) order by sum(`mt`.`CURRENT_NUMBER_OF_BYTES_USED`) desc;
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `x$memory_global_total` (`total_allocated`) AS select sum(`performance_schema`.`memory_summary_global_by_event_name`.`CURRENT_NUMBER_OF_BYTES_USED`) AS `total_allocated` from `performance_schema`.`memory_summary_global_by_event_name`;

-- Menghapus tabel sementara dan menciptakan struktur VIEW terakhir
DROP TABLE IF EXISTS `x$processlist`;
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `x$processlist` (`thd_id`,`conn_id`,`user`,`db`,`command`,`state`,`time`,`current_statement`,`execution_engine`,`statement_latency`,`progress`,`lock_latency`,`cpu_latency`,`rows_examined`,`rows_sent`,`rows_affected`,`tmp_tables`,`tmp_disk_tables`,`full_scan`,`last_statement`,`last_statement_latency`,`current_memory`,`last_wait`,`last_wait_latency`,`source`,`trx_latency`,`trx_state`,`trx_autocommit`,`pid`,`program_name`) AS select `pps`.`THREAD_ID` AS `thd_id`,`pps`.`PROCESSLIST_ID` AS `conn_id`,if((`pps`.`NAME` in ('thread/sql/one_connection','thread/thread_pool/tp_one_connection')),concat(`pps`.`PROCESSLIST_USER`,'@',convert(`pps`.`PROCESSLIST_HOST` using utf8mb4)),replace(`pps`.`NAME`,'thread/','')) AS `user`,`pps`.`PROCESSLIST_DB` AS `db`,`pps`.`PROCESSLIST_COMMAND` AS `command`,`pps`.`PROCESSLIST_STATE` AS `state`,`pps`.`PROCESSLIST_TIME` AS `time`,`pps`.`PROCESSLIST_INFO` AS `current_statement`,`pps`.`EXECUTION_ENGINE` AS `execution_engine`,if((`esc`.`END_EVENT_ID` is null),`esc`.`TIMER_WAIT`,NULL) AS `statement_latency`,if((`esc`.`END_EVENT_ID` is null),round((100 * (`estc`.`WORK_COMPLETED` / `estc`.`WORK_ESTIMATED`)),2),NULL) AS `progress`,`esc`.`LOCK_TIME` AS `lock_latency`,`esc`.`CPU_TIME` AS `cpu_latency`,`esc`.`ROWS_EXAMINED` AS `rows_examined`,`esc`.`ROWS_SENT` AS `rows_sent`,`esc`.`ROWS_AFFECTED` AS `rows_affected`,`esc`.`CREATED_TMP_TABLES` AS `tmp_tables`,`esc`.`CREATED_TMP_DISK_TABLES` AS `tmp_disk_tables`,if(((`esc`.`NO_GOOD_INDEX_USED` > 0) or (`esc`.`NO_INDEX_USED` > 0)),'YES','NO') AS `full_scan`,if((`esc`.`END_EVENT_ID` is not null),`esc`.`SQL_TEXT`,NULL) AS `last_statement`,if((`esc`.`END_EVENT_ID` is not null),`esc`.`TIMER_WAIT`,NULL) AS `last_statement_latency`,`mem`.`current_allocated` AS `current_memory`,`ewc`.`EVENT_NAME` AS `last_wait`,if(((`ewc`.`END_EVENT_ID` is null) and (`ewc`.`EVENT_NAME` is not null)),'Still Waiting',`ewc`.`TIMER_WAIT`) AS `last_wait_latency`,`ewc`.`SOURCE` AS `source`,`etc`.`TIMER_WAIT` AS `trx_latency`,`etc`.`STATE` AS `trx_state`,`etc`.`AUTOCOMMIT` AS `trx_autocommit`,`conattr_pid`.`ATTR_VALUE` AS `pid`,`conattr_progname`.`ATTR_VALUE` AS `program_name` from (((((((`performance_schema`.`threads` `pps` left join `performance_schema`.`events_waits_current` `ewc` on((`pps`.`THREAD_ID` = `ewc`.`THREAD_ID`))) left join `performance_schema`.`events_stages_current` `estc` on((`pps`.`THREAD_ID` = `estc`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `esc` on((`pps`.`THREAD_ID` = `esc`.`THREAD_ID`))) left join `performance_schema`.`events_transactions_current` `etc` on((`pps`.`THREAD_ID` = `etc`.`THREAD_ID`))) left join `x$memory_by_thread_by_current_bytes` `mem` on((`pps`.`THREAD_ID` = `mem`.`thread_id`))) left join `performance_schema`.`session_connect_attrs` `conattr_pid` on(((`conattr_pid`.`PROCESSLIST_ID` = `pps`.`PROCESSLIST_ID`) and (`conattr_pid`.`ATTR_NAME` = '_pid')))) left join `performance_schema`.`session_connect_attrs` `conattr_progname` on(((`conattr_progname`.`PROCESSLIST_ID` = `pps`.`PROCESSLIST_ID`) and (`conattr_progname`.`ATTR_NAME` = 'program_name')))) order by `pps`.`PROCESSLIST_TIME` desc,`last_wait_latency` desc;

-- Menghapus tabel sementara dan menciptakan struktur VIEW terakhir
DROP TABLE IF EXISTS `x$ps_digest_95th_percentile_by_avg_us`;
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `x$ps_digest_95th_percentile_by_avg_us` (`avg_us`,`percentile`) AS select `s2`.`avg_us` AS `avg_us`,ifnull((sum(`s1`.`cnt`) / nullif((select count(0) from `performance_schema`.`events_statements_summary_by_digest`),0)),0) AS `percentile` from (`x$ps_digest_avg_latency_distribution` `s1` join `x$ps_digest_avg_latency_distribution` `s2` on((`s1`.`avg_us` <= `s2`.`avg_us`))) group by `s2`.`avg_us` having (ifnull((sum(`s1`.`cnt`) / nullif((select count(0) from `performance_schema`.`events_statements_summary_by_digest`),0)),0) > 0.95) order by `percentile` limit 1;

-- Menghapus tabel sementara dan menciptakan struktur VIEW terakhir
DROP TABLE IF EXISTS `x$ps_digest_avg_latency_distribution`;
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `x$ps_digest_avg_latency_distribution` (`cnt`,`avg_us`) AS select count(0) AS `cnt`,round((`performance_schema`.`events_statements_summary_by_digest`.`AVG_TIMER_WAIT` / 1000000),0) AS `avg_us` from `performance_schema`.`events_statements_summary_by_digest` group by `avg_us`;
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `x$schema_table_lock_waits` (`object_schema`,`object_name`,`waiting_thread_id`,`waiting_pid`,`waiting_account`,`waiting_lock_type`,`waiting_lock_duration`,`waiting_query`,`waiting_query_secs`,`waiting_query_rows_affected`,`waiting_query_rows_examined`,`blocking_thread_id`,`blocking_pid`,`blocking_account`,`blocking_lock_type`,`blocking_lock_duration`,`sql_kill_blocking_query`,`sql_kill_blocking_connection`) AS select `g`.`OBJECT_SCHEMA` AS `object_schema`,`g`.`OBJECT_NAME` AS `object_name`,`pt`.`THREAD_ID` AS `waiting_thread_id`,`pt`.`PROCESSLIST_ID` AS `waiting_pid`,`sys`.`ps_thread_account`(`p`.`OWNER_THREAD_ID`) AS `waiting_account`,`p`.`LOCK_TYPE` AS `waiting_lock_type`,`p`.`LOCK_DURATION` AS `waiting_lock_duration`,`pt`.`PROCESSLIST_INFO` AS `waiting_query`,`pt`.`PROCESSLIST_TIME` AS `waiting_query_secs`,`ps`.`ROWS_AFFECTED` AS `waiting_query_rows_affected`,`ps`.`ROWS_EXAMINED` AS `waiting_query_rows_examined`,`gt`.`THREAD_ID` AS `blocking_thread_id`,`gt`.`PROCESSLIST_ID` AS `blocking_pid`,`sys`.`ps_thread_account`(`g`.`OWNER_THREAD_ID`) AS `blocking_account`,`g`.`LOCK_TYPE` AS `blocking_lock_type`,`g`.`LOCK_DURATION` AS `blocking_lock_duration`,concat('KILL QUERY ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_query`,concat('KILL ',`gt`.`PROCESSLIST_ID`) AS `sql_kill_blocking_connection` from (((((`performance_schema`.`metadata_locks` `g` join `performance_schema`.`metadata_locks` `p` on(((`g`.`OBJECT_TYPE` = `p`.`OBJECT_TYPE`) and (`g`.`OBJECT_SCHEMA` = `p`.`OBJECT_SCHEMA`) and (`g`.`OBJECT_NAME` = `p`.`OBJECT_NAME`) and (`g`.`LOCK_STATUS` = 'GRANTED') and (`p`.`LOCK_STATUS` = 'PENDING')))) join `performance_schema`.`threads` `gt` on((`g`.`OWNER_THREAD_ID` = `gt`.`THREAD_ID`))) join `performance_schema`.`threads` `pt` on((`p`.`OWNER_THREAD_ID` = `pt`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `gs` on((`g`.`OWNER_THREAD_ID` = `gs`.`THREAD_ID`))) left join `performance_schema`.`events_statements_current` `ps` on((`p`.`OWNER_THREAD_ID` = `ps`.`THREAD_ID`))) where (`g`.`OBJECT_TYPE` = 'TABLE');
...
CREATE ALGORITHM=TEMPTABLE SQL SECURITY INVOKER VIEW `x$schema_table_statistics_with_buffer` (`table_schema`,`table_name`,`rows_fetched`,`fetch_latency`,`rows_inserted`,`insert_latency`,`rows_updated`,`update_latency`,`rows_deleted`,`delete_latency`,`io_read_requests`,`io_read`,`io_read_latency`,`io_write_requests`,`io_write`,`io_write_latency`,`io_misc_requests`,`io_misc_latency`,`innodb_buffer_allocated`,`innodb_buffer_data`,`innodb_buffer_free`,`innodb_buffer_pages`,`innodb_buffer_pages_hashed`,`innodb_buffer_pages_old`,`innodb_buffer_rows_cached`) AS select `pst`.`OBJECT_SCHEMA` AS `table_schema`,`pst`.`OBJECT_NAME` AS `table_name`,`pst`.`COUNT_FETCH` AS `rows_fetched`,`pst`.`SUM_TIMER_FETCH` AS `fetch_latency`,`pst`.`COUNT_INSERT` AS `rows_inserted`,`pst`.`SUM_TIMER_INSERT` AS `insert_latency`,`pst`.`COUNT_UPDATE` AS `rows_updated`,`pst`.`SUM_TIMER_UPDATE` AS `update_latency`,`pst`.`COUNT_DELETE` AS `rows_deleted`,`pst`.`SUM_TIMER_DELETE` AS `delete_latency`,`fsbi`.`count_read` AS `io_read_requests`,`fsbi`.`sum_number_of_bytes_read` AS `io_read`,`fsbi`.`sum_timer_read` AS `io_read_latency`,`fsbi`.`count_write` AS `io_write_requests`,`fsbi`.`sum_number_of_bytes_write` AS `io_write`,`fsbi`.`sum_timer_write` AS `io_write_latency`,`fsbi`.`count_misc` AS `io_misc_requests`,`fsbi`.`sum_timer_misc` AS `io_misc_latency`,`ibp`.`allocated` AS `innodb_buffer_allocated`,`ibp`.`data` AS `innodb_buffer_data`,(`ibp`.`allocated` - `ibp`.`data`) AS `innodb_buffer_free`,`ibp`.`pages` AS `innodb_buffer_pages`,`ibp`.`pages_hashed` AS `innodb_buffer_pages_hashed`,`ibp`.`pages_old` AS `innodb_buffer_pages_old`,`ibp`.`rows_cached` AS `innodb_buffer_rows_cached` from ((`performance_schema`.`table_io_waits_summary_by_table` `pst` left join `x$ps_schema_table_statistics_io` `fsbi` on(((`pst`.`OBJECT_SCHEMA` = `fsbi`.`table_schema`) and (`pst`.`OBJECT_NAME` = `fsbi`.`table_name`)))) left join `x$innodb_buffer_stats_by_table` `ibp` on(((`pst`.`OBJECT_SCHEMA` = `ibp`.`object_schema`) and (`pst`.`OBJECT_NAME` = `ibp`.`object_name`)))) order by `pst`.`SUM_TIMER_WAIT` desc;
